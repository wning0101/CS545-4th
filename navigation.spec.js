...
//import {nav} from ./bot/robot;
import 'mocha';
import { Direction} from './navigation';
describe('Direction', () => {
describe('isCardinal', () => {
    it('should be true for north', () => {
        expect(Direction.NORTH.isCardinal()).equal(Direction.SOUTH);
    });
    it('should be true for east', () => {
        expect(Direction.EAST.isCardinal()).equal(Direction.WEST);
    });
});
describe('opposite', () => {
...
it("to comapss dir should throw an errpr",() =>{
expect(nav.tocompassdir).to.throw("Dir is mandatory!");
});
});*/
